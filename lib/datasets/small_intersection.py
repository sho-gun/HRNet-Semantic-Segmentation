...
class SmallIntersection(BaseDataset):
    def __init__(self,
                 root,
                 list_path,
                 num_samples=None,
        ...
        super(SmallIntersection, self).__init__(ignore_label, base_size,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = cv2.imread(os.path.join(self.root,'small_intersection',item["img"]),
                           cv2.IMREAD_COLOR)
        size = image.shape
